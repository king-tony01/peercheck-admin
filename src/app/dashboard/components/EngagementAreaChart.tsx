        ...
        <div className={styles.legend}>
          <div className={styles.legend_item}>
            <div
              ...
              style={{ background: green.users }}
            />
            <span className={styles.legend_label}>Total Users</span>
          </div>
          <div className={styles.legend_item}>
            <div
              className={styles.legend_dot}
              style={{ background: green.reviews }}
            />
            <span className={styles.legend_label}>Total Reviews</span>
          </div>
        </div>
      </div>
